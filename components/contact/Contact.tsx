...
export default async function Contact({ lang }: { lang: Locale }) {
   ...
   return (
      <section
         id="contact"
         className="grid grid-cols-1 bg-gray-200 dark:bg-gray-800 lg:grid-cols-[1fr_2fr] lg:gap-x-4 gap-y-4 items-start p-4 border-b border-black/10 dark:border-white/10 w-full"
      >
